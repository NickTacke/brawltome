...
export {
  ...
  leaderboardRecentActivityEntrySchema,
  ...
  type LeaderboardRecentActivityEntry,
  type LeaderboardRecentActivityInput,
  type LeaderboardRecentActivityOutput,
