...
describe('PinnedPlayersSection', () => {
  test('renders concise ranked card facts without explanatory copy', () => {
    ...
    expect(html).toContain('<ol class="flex flex-col gap-3">')
    ...
    expect(html).toContain('Win rate 50.0%')
    expect(html).toContain('Update delayed')
    expect(html).not.toContain('Up 50 rating')
    expect(html).not.toContain('Checked 2026-08-10')
