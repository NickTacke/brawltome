...
import {
  Card, Badge, Avatar, AvatarFallback, AvatarImage, Button,
} from '@brawltome/ui'
            ...
            >
              <div className="p-4 space-y-3 relative overflow-hidden">
                <div className="flex items-center gap-4 relative z-10">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 text-[10px] text-muted-foreground font-mono">
                      ...
                      <span className={wr > 50 ? 'text-success font-bold' : ''}>
                        {wr.toFixed(0)}% WR
                      </span>
                      <span className="opacity-30">&bull;</span>
                ...
                {isExpanded && (() => {
                  ...
                  const dmgRatio = legendDmgDealt + legendDmgTaken > 0
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-0">
                        ...
                        <div className="space-y-3 md:pr-4 md:border-r md:border-border/30">
                          ...
                          <div className="grid grid-cols-4 gap-1 text-center">
                            ...
                            <div className="p-1.5 rounded bg-background/20 hover:bg-background/30 transition-colors">
                              <div className="text-sm font-black text-foreground">
                                {legendKOs > 0
                                  ? formatNum(Math.round(legendDmgDealt / legendKOs))
                                  : '\u2014'}
                              </div>
                        ...
                        <div className="space-y-3 md:pl-4">
                          ...
                          {rankedLegend ? (
                            (() => {
                              const rankedWinrate =
                                rankedLegend.games > 0
                                  ? (rankedLegend.wins / rankedLegend.games) * 100
                                  : 0
                              return (
