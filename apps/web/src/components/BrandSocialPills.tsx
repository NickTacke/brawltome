...
/**
 * Colored brand pill social row (Discord / X / GitHub). Used by both
 * MaintenancePage and WorkInProgress. The monochrome in-sidebar version lives
 * separately in `sidebar/social-links.tsx` — these two visual treatments are
 * deliberately different.
 */
export function BrandSocialPills() {
  return (
